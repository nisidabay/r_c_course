/*
 * 05_zero_copy.c — The magic of zero-copy slicing
 *
 * Tony Banters' "Strings Aren't Real" — Day 5 (THE BIG REVEAL)
 *
 * KEY INSIGHT: slice_take and slice_drop create new slices by
 * ADJUSTING the data pointer and length. NO malloc, NO memcpy,
 * NO character copying. Just pointer arithmetic. This is
 * the power of the data+len pattern — slicing without allocating.
 *
 * gcc -std=c11 -Wall -Wextra -pedantic 05_zero_copy.c -o 05_zero_copy
 */
...
// Thinking in C:
// slice_take clamps .len. slice_drop advances .data and shrinks .len.
// Both are O(1), zero-copy, and allocation-free.
// This is the killer feature of data+len strings — substring operations
// that don't copy or allocate. C strings cannot do this safely.
