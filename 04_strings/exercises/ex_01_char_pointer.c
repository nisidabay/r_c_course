/*
 * Exercise 01: char* is a pointer (8 bytes), not a string
 *
 ...
 * The program demonstrates that sizeof(char*) is always 8,
 * while sizeof on an array gives the full byte count including '\0'.
 *
