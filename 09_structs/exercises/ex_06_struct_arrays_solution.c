/*
 * Exercise 06: Struct Arrays — SOLUTION
 *
 * Array of structs — declare, initialise, iterate, modify.
 */
...
int main(void) {
    ...
    catalogue[0].price = 899.99;

    /* Update the quantity of the third product (Keyboard) */
    catalogue[2].quantity = 45;
